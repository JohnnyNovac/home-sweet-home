...
class DeviceControllerTest {
    ...
    void postCreatesDevice() throws Exception {
        when(deviceService.create(any()))
                .thenReturn(new DeviceDto("esp01", "climate", "bedroom", "NodeMCU-1", null, null, null, null));
    ...
    void getReturnsDevices() throws Exception {
        when(deviceService.getDevices(0, 20))
                .thenReturn(new PageImpl<>(List.of(new DeviceDto("esp01", "climate", "bedroom", "NodeMCU-1", null, null, null, null))));
